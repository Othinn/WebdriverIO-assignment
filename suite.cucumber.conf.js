...
//
  ...
  cucumberOpts: {
      ...
      require: ['./stepDefinitions/*.js'],   // <string[]> (file/dir) require files before executing features: ['./stepDifinitions'],        // <string[]> (file/dir) require files before executing features
